...
const Footer = () => {
  ...
  return (
    ...
    //           <div className="relative -mt-20 h-64 w-64 sm:absolute sm:mt-25 sm:h-52 sm:w-52">
    // <Image
    //   src="/logo-light.png"
    //   alt="Meu certificado digital logo"
    //   fill
    ...
    //             <li className="mb-4 text-sm sm:text-base">
    //               <Link
    //                 href="/doc/termodereembolso.pdf"
    //                 target="_blank"
    //                 className="hover:text-blue-600 hover:underline"
    ...
    //               CNPJ: 60.591.832/0001-51
    //             </li>
    //             <li className="mb-2 text-sm sm:text-base">
    //               Email: meucd@meucd.servicos.ws
    //             </li>
    //             <li className="text-sm sm:text-base">
    //               Celular: (51) 9 9132-9735
    //             </li>
    //           </ul>
    //         </div>
    //       </div>
    ...
    //         © {currentYear} Meu Certificado Digital. Todos os Direitos
    //         Reservados.
    //       </span>
